...
namespace lrender
{
    ...
    */
    ...
    public:
        ...
        inline static f32 invTanTheta(const Vector3& v);
    ...
    {
        f32 sn2 = sinTheta2(v);
        if(sn2<=LRENDER_ANGLE_EPSILON){
            return 0.0f;
        }
        return sqrt(sn2)/v.z_;
    }
    ...
    inline f32 LocalCoordinate::invTanTheta(const Vector3& v)
    {
    ...
    inline f32 LocalCoordinate::cosPhi(const Vector3& v)
    {
        ...
        if(snTheta<=LRENDER_ANGLE_EPSILON){
            return 1.0f;
        }
        return clamp(v.x_/snTheta, -1.0f, 1.0f);
    }

    inline f32 LocalCoordinate::cosPhi2(const Vector3& v)
    {
        return clamp01(v.x_*v.x_/sinTheta2(v));
    }
    ...
    inline f32 LocalCoordinate::sinPhi(const Vector3& v)
    {
        ...
        return clamp(v.y_/snTheta, -1.0f, 1.0f);
    }

    inline f32 LocalCoordinate::sinPhi2(const Vector3& v)
    {
        return clamp01(v.y_*v.y_/sinTheta2(v));
    }
